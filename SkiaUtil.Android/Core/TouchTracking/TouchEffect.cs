...
namespace SkiaUtil.Android.Core.TouchTracking
{
    public class TouchEffect : PlatformEffect
    {
        global::Android.Views.View view;
        Element formsElement;
        SkiaUtil.Core.TouchTracking.TouchEffect pclTouchEffect;
        bool capture;
        Func<double, double> fromPixels;
        int[] twoIntArray = new int[2];

        static Dictionary<global::Android.Views.View, TouchEffect> viewDictionary =
            new Dictionary<global::Android.Views.View, TouchEffect>();
